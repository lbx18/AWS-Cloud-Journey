...
![Create IAM Role](screenshots/01_create_role.png)

![Create IAM Role](screenshots/011_create_role.png)
...
![Policy Attached to Role](screenshots/02_policy_attached_to_role.png)
*AmazonS3ReadOnlyAccess policy attached to EC2-S3-ReadOnly-Role*

![Role Attached to EC2](screenshots/022_role_attached_ec2.png)
*Role successfully associated with EC2 instance*

![S3 List from EC2](screenshots/0222_s3_list_from_ec2.png)
...
![Roles vs Users Comparison](screenshots/03_roles_vs_users.png)
...
![AWS IAM Essentials](screenshots/Identity_and_Access_Management_Essentials.png)
