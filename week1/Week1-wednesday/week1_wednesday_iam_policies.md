...
![IAM Policy Structure](screenshots/01_policy_structure.png)
...
![Create Policy JSON Tab](screenshots/02_create_policy_json.png)
*Custom S3 read-only policy written in the JSON editor*

![Create Policy JSON Tab](screenshots/022_policy_created.png)
...
![Policy Simulator](screenshots/03_policy_simulator.png)
*IAM Policy Simulator — testing s3:GetObject — result: Allowed*

![Policy Simulator Deny](screenshots/033_policy_simulator_deny.png)
...
![Policy Attached to User](screenshots/04_policy_attached.png)
*S3-ReadOnly-MyLabBucket policy attached to lab-readonly user*

![Access Denied Upload](screenshots/044_access_denied.png)
*lab-readonly user gets AccessDenied when attempting to upload — policy working correctly*

![EC2 Access Denied](screenshots/0444_ec2_denied.png)
